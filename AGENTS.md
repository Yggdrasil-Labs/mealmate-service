# MealMate Service Agent Guide

本文件面向进入本仓库协作的 AI Agent、自动化脚本与开发者，目标是让协作者在第一时间理解本项目的技术事实、分层边界、编码规范与发布约束，避免写出“能跑但不符合 MealMate / COLA 5 约定”的代码。
