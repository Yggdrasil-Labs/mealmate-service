...
class UpdateRecipeStepsCmdExeTest {
    ...
    @Test
    void shouldRejectUpdateStepsWhenRecipeIsSystem() {
        ...
        UpdateRecipeStepsCmdExe cmdExe =
                new UpdateRecipeStepsCmdExe(recipeRepository, recipeDomainService, recipeConvertor);
