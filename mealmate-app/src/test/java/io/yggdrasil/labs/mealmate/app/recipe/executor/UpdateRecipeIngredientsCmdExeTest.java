...
class UpdateRecipeIngredientsCmdExeTest {
    ...
    @Test
    void shouldRejectUpdateIngredientsWhenRecipeIsSystem() {
        ...
        UpdateRecipeIngredientsCmdExe cmdExe =
                new UpdateRecipeIngredientsCmdExe(
